...
public class AssegnatoController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('ADMIN') or @progettoAuthService.isCapoProgettoDiAttivita(#assegnato.idAttivita, authentication)")
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or " + "(@progettoAuthService.isCapoProgettoDiAssegnato(#id, authentication) " + "and (#assegnato.idAttivita == null or @progettoAuthService.isCapoProgettoDiAttivita(#assegnato.idAttivita, authentication)))")
