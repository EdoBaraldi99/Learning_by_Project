...
public class AssociatoController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('ADMIN') or " + "(@progettoAuthService.isCapoProgetto(#associato.idProgetto, authentication) " + "and #associato.ruolo == 'Dipendente')")
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or @progettoAuthService.isCapoProgettoDiAssociato(#id, authentication)")
